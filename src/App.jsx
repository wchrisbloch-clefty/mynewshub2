...
async function fetchRSS(url){
  ...
  try{
    ...
    if(d.contents){
      ...
      return Array.from(x.querySelectorAll('item')).slice(0,12).map(i=>({
        title:i.querySelector('title')?.textContent||'',
        link:i.querySelector('link')?.textContent||'',
        desc:(i.querySelector('description')?.textContent||'').replace(/<[^>]*>/g,'').slice(0,160),
  ...
  const BloomBlock=()=>{
    ...
    return(
      <div className="cat-block bloom-block bloom-row">
        ...
        arts2.length===0?<div className="loading-state">No articles yet</div>:(
      ...
      <div className="sidebar">
        ...
        {cat==='bloom'&&(
          <div className="side-block" style={{border:'1px solid #bae6fd'}}>
            ...
            <div style={{fontSize:'11px',color:'var(--text2)',lineHeight:'1.6'}}>Tracks Bloom Energy (NYSE: BE), fuel cells, distributed power, AI data center power, onshoring, industrial energy, oil and gas power needs, and utility-scale solutions.</div>
          </div>
        )}
        <div className="side-block">
        ...
        <div className="panel">
          ...
          <div className="panel-body">
            <div className="p-sec">
              ...
              <div>{la.map((a,i)=><span key={i} classNa
